# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-10-22 14:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hero_kicker', models.CharField(blank=True, help_text='By default this will be the same as the page title but you can override it here.', max_length=255, null=True, verbose_name='Kicker')),
                ('hero_title', models.CharField(max_length=255, verbose_name='Title')),
                ('hero_text', models.TextField(max_length=500, verbose_name='Text')),
                ('hero_link_text', models.CharField(blank=True, max_length=100, null=True, verbose_name='Link text')),
                ('hero_link_url', models.CharField(blank=True, help_text='If you want to link to an external page, please use this.', max_length=200, null=True, verbose_name='Link URL')),
                ('hero_image', cms.apps.media.models.ImageRefField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='media.File', verbose_name='Image')),
                ('hero_link_page', models.ForeignKey(blank=True, help_text='If you want to link to an internal page, please use this.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='pages.Page', verbose_name='Link page')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='page',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='destinations.Destinations'),
        ),
        migrations.AddField(
            model_name='destination',
            name='twitter_image',
