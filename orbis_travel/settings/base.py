...
SITE_NAME = 'Orbis Travel'

SITE_DOMAIN = 'orbistravel.com'
...
ALLOWED_HOSTS = [
    ...
    'www.orbistravel.eik.me.onespace.media',
]
...
MEDIA_ROOT = '/var/www/orbis_travel_media'
...
STATIC_ROOT = '/var/www/orbis_travel_static'

STATIC_URL = '/static/'

NODE_MODULES_ROOT = '/var/www/orbis_travel_static'
...
INSTALLED_APPS = [
    ...
    # 'orbis_travel.apps.partners',
    # 'orbis_travel.apps.people',
    'orbis_travel.apps.redirects',
    'orbis_travel.apps.sections',
    'orbis_travel.apps.settings',
    'orbis_travel.apps.site',
...
MIDDLEWARE_CLASSES = (
    ...
    'orbis_travel.apps.redirects.middleware.RedirectFallbackMiddleware',
...
ROOT_URLCONF = 'orbis_travel.urls'

WSGI_APPLICATION = 'orbis_travel.wsgi.application'
...
CACHE_MIDDLEWARE_KEY_PREFIX = 'orbis_travel'
...
SECRET_KEY = '5PoPReuWIEMoKQVfx21kgeqmwzvMVE4TO/yhJC0mjMTfNonmOKb+ZKYngU5282c842I='
